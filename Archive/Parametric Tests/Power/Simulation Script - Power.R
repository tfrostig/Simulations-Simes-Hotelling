...
setwd('C:/Users/user/Google Drive/Simes Hotelling Paper/Simes Hoteling V2 - No HC/R Script/Full Simulation 21112018/Parametric Tests/Power')
...
## Name Vector 
Name.Vec <- c('Srivastava', 'Chen', 'Lopes', 'SH.Ln.LB', 'SH.Sn.LB', 'GCT', 'Simes', 'KNN')
L        <- length(Name.Vec)
## Run tests 
