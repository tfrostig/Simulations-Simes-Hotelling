...
set.seed(998)
setwd('Non-equal Covaraince/Type I error')
...
write.csv(power.simulation.matrix.1, 'nonequal.alpha.simulation.matrix.1.csv', row.names = FALSE)
...
write.csv(power.simulation.matrix.3, 'nonequal.alpha.simulation.matrix.3.csv', row.names = FALSE)
...
write.csv(power.simulation.matrix.5, 'nonequal.alpha.simulation.matrix.5.csv', row.names = FALSE)
...
## Run Simulation 
print('Simulation equicorrelated')
...
write.csv(power.simulation.matrix.7,'nonequal.alpha.simulation.matrix.7.csv', row.names = FALSE)